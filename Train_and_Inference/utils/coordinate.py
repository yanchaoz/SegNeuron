...
class Coordinate(tuple):
    ...
    def __new__(cls, array_like):
        return super().__new__(cls, [int(x) if x is not None else None for x in array_like])
    ...
    def __add__(self, other):
        ...
        return Coordinate(
            a + b if a is not None and b is not None else None for a, b in zip(self, other)
        )
