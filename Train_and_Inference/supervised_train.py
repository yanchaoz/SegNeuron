...
def build_model(cfg, writer):
    ...
    if cfg.MODEL.pre_train:
        ...
        pretrained_dict = {
            ...
            if (k in model_dict) and ("up" not in k) and ("outputs" not in k)
...
def calculate_lr(iters):
    ...
    elif iters < cfg.TRAIN.decay_iters:
        current_lr = (cfg.TRAIN.base_lr - cfg.TRAIN.end_lr) * pow(
        ...
        if iters % cfg.TRAIN.display_freq == 0 or iters == 1:
            ...
            if iters == 1:
                ...
                logging.info(
                    ...
                    % (
                        iters,
                        sum_loss / cfg.TRAIN.display_freq * 1,
            ...
            f_loss_txt.write(
                "step = %d, loss = %.6f, labeled_loss=%.6f"
                % (
                    iters,
                    sum_loss / cfg.TRAIN.display_freq * 1,
                    sum_labeled_loss / cfg.TRAIN.display_freq * 1,
